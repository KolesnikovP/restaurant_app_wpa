...
// Not used for native flow; mobile uses id_token → POST /auth/google/mobile
export const GOOGLE_REDIRECT_URI = `${process.env.EXPO_PUBLIC_BASE_URL || ''}`;
...
export const APPLE_REDIRECT_URI = `${process.env.EXPO_PUBLIC_BASE_URL}/auth/apple/callback`;
